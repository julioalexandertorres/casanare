var ol_control_PrintDialog = (function () {

  document.getElementById('select-landscape').addEventListener('click', function() {
    document.querySelector('input[name="ol-print-orientation"][value="landscape"]').checked = true;
  });

  var ol_ext_element = ol.ext.element;
  var ol_control_Control = ol.control.Control;
  var ol_style_Stroke = ol.style.Stroke;
  var ol_control_Dialog = ol.control.Dialog;
  var ol_control_Legend = ol.control.Legend;
  var ol_control_Print = ol.control.Print;
  var ol_control_CanvasTitle = ol.control.CanvasTitle;
  var ol_sphere_getMapScale = ol.sphere.getMapScale;
  var ol_sphere_setMapScale = ol.sphere.setMapScale;
  var ol_control_Compass = ol.control.Compass;
...
ol_control_PrintDialog.prototype._labels = {
  en: {
    ...
    custom: 'Tamaño de la pantalla',
    margin: 'Margen',
    scale: 'Escale',
    legend: 'Leyenda',
    north: 'Norte',
    mapTitle: 'Titulo del mapa',
    saveas: 'Guardar como...',
    saveLegend: 'Guardar leyenda...',
    copied: '✔ Copiar en el portapapeles',
    errorMsg: 'Can\'t save map canvas...',
    printBt: 'Imprimir...',
    clipboardFormat: 'Copiar en el portapapeles...',
...
return ol_control_PrintDialog; // Esto es para que la clase esté disponible globalmente
})();