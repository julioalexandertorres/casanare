...
import { viewer } from '../../../../visor3d/CesiumViewer.js';
...
function addressSelectPredio(event, ui){
    //try{
        ...
        GeoJsonDataSource.load(geojsonpredio).then(function (dataSource) {
            ...
            if (entities.length > 0) {
                ...
                for (var i = 0; i < entities.length; i++) {
                    boundingSphere = BoundingSphere.union(boundingSphere, entities[i].computeBoundingSphere());
                }
